  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[#3B3839]">
      <div className="w-full max-w-3xl bg-black p-8 rounded shadow-lg">
        <h1 className="text-7xl font-bold iceberg-regular text-center mb-10 bg-gradient-to-r from-orange-500 to-orange-800 text-transparent bg-clip-text">User Sign Up</h1>
