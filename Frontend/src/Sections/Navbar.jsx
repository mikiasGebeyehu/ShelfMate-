...
const Navbar = () => {
  ...
  const renderAuthButtons = () => (
    <div className="flex gap-2 mt-5 lg:mt-0 mr-10">
       <Link to="/user-signUp">
  ...
  return (
    <nav className="fixed flex justify-between items-center w-full p-2 bg-black/40 backdrop-blur-md mx-8 border-b sticky top-0 ">
      ...
      <div className="flex-col items-center flex-shrink-0">
        ...
        <p className="playwrite-gb-s text-lg text-yellow-500 ">read here to get more</p>
      </div>
      ...
      <button onClick={toggleNavbar} className="bg-orange-500 p-2 rounded-md mr-10">
